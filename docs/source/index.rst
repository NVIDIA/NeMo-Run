...
``pip install git+https://gitlab-master.nvidia.com/nemo-ux/NeMo-Run.git``

To install Skypilot, we have optional features available.

``pip install git+https://gitlab-master.nvidia.com/nemo-ux/NeMo-Run.git[skypilot]``
will install Skypilot w Kubernetes

``pip install git+https://gitlab-master.nvidia.com/nemo-ux/NeMo-Run.git[skypilotmore
