...
class TestRunAIExecutor:
    def test_init(self):
        executor = RunAIExecutor(
            base_url="https://runaiapi.example.com",
            app_id="test_app_id",
        ...
        assert executor.base_url == "https://runaiapi.example.com"
    ...
    def test_get_auth_token_success(self, mock_post):
        ...
        mock_post.assert_called_once_with(
            "https://runaiapi.example.com/token",
            json={
                "grantType": "app_token",
                "appId": "test_app_id",
    ...
    def test_get_project_and_cluster_id_success(self, mock_get):
        ...
        mock_get.assert_called_once_with(
            "https://runaiapi.example.com/org-unit/projects",
    ...
    @patch("requests.post")
    @patch.object(RunAIExecutor, "copy_directory_data_command")
    ...
    def test_delete_workload(self, mock_delete):
        ...
        mock_delete.assert_called_once_with(
            "https://runaiapi.example.com/workloads/workspaces/job123",
            headers=executor._default_headers(token="test_token"),
        )

    @patch("time.sleep")
    @patch.object(RunAIExecutor, "create_data_mover_workload")
    @patch.object(RunAIExecutor, "status")
    @patch.object(RunAIExecutor, "delete_workload")
    def test_move_data_success(self, mock_delete, mock_status, mock_create, mock_sleep):
        ...
        mock_status.side_effect = [RunAIState.PENDING, RunAIState.COMPLETED]
    ...
    def test_move_data_failed(self, mock_status, mock_create, mock_sleep):
        ...
        mock_status.return_value = RunAIState.FAILED
    ...
    @patch.object(RunAIExecutor, "get_auth_token")
    @patch.object(RunAIExecutor, "get_project_and_cluster_id")
    @patch.object(RunAIExecutor, "move_data")
    @patch.object(RunAIExecutor, "create_distributed_job")
    ...
    def test_status(self, mock_get):
        ...
        with patch.object(RunAIExecutor, "get_auth_token", return_value="test_token"):
            executor = RunAIExecutor(
                base_url="https://runaiapi.example.com",
                app_id="test_app_id",
                app_secret="test_app_secret",
            ...
            assert status == RunAIState.RUNNING
            mock_get.assert_called_once_with(
                "https://runaiapi.example.com/workloads/job123",
                headers=executor._default_headers(token="test_token"),
            )

    @patch("requests.get")
    def test_status_no_token(self, mock_get):
        with patch.object(RunAIExecutor, "get_auth_token", return_value=None):
            executor = RunAIExecutor(
                base_url="https://runaiapi.example.com",
                app_id="test_app_id",
                app_secret="test_app_secret",
    ...
    def test_status_error_response(self, mock_get):
        ...
        with patch.object(RunAIExecutor, "get_auth_token", return_value="test_token"):
            ...
            assert status == RunAIState.UNKNOWN
    ...
    def test_cancel(self, mock_get):
        ...
        with patch.object(RunAIExecutor, "get_auth_token", return_value="test_token"):
            ...
            mock_get.assert_called_once_with(
                "https://runaiapi.example.com/workloads/distributed/job123/suspend",
                headers=executor._default_headers(token="test_token"),
            )
    ...
    def test_logs(self):
        with patch("logging.Logger.warning") as mock_warning:
            RunAIExecutor.logs("app123", "/path/to/fallback")
