from llama3_70b_BF16 import *

@run.cli.factory
def llama3_fp8_trainer(num_nodes=8, callbacks=None) -> run.Config[nl.Trainer]:
    callbacks=[
...
def train_model(
        ctx: run.cli.RunContext = run.cli.RunContext(name="pretrain_llama3_70b_fp8_ctx"),
        ...
        log: nl.NeMoLogger = set_log_dir(
            ...
            exp_name="pretrain_llama3_70b_fp8"
            ),
