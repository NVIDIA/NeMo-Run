from nemotron_340b_BF16 import *

@run.cli.factory
def nemotron_fp8_trainer(num_nodes=16, callbacks=None) -> run.Config[nl.Trainer]:
    callbacks=[
...
def train_model(
        ctx: run.cli.RunContext = run.cli.RunContext(name="pretrain_nemotron_340b_fp8_ctx"),
        ...
        log=set_log_dir(
            ...
            exp_name="pretrain_nemotron_340b_fp8"
            ),
