...
from nemo.collections.llm.gpt.model.nemotron import Nemotron4Config15B, NemotronModel, NemotronConfig
...
def model() -> run.Config[pl.LightningModule]:
    model_obj = run.Config(NemotronModel, config=run.Config(Nemotron4Config15B))
...
@run.cli.factory
def nemotron_trainer(num_nodes=8, callbacks=None) -> run.Config[nl.Trainer]:
    callbacks=[
...
def train_model(
        ...
        log=set_log_dir(
            ...
            exp_name="pretrain_nemotron_15b_bf16"
            ),
